...
import ch2s6Raw from '@/content/ch2/s6.md?raw';
...
import ch9s2Raw from '@/content/ch9/s2.md?raw';
...
function PageRenderer({ pageId }: { pageId: PageId }) {
  ...
  switch (pageId) {
    ...
    case 'ch2-s6': return <SectionPage pageId={pageId} content={ch2s6Raw} />;
    ...
    case 'ch9-s2': return <SectionPage pageId={pageId} content={ch9s2Raw} />;
