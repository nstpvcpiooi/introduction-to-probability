...
Định lý 7.2.1 (2D LOTUS). Gọi  $g$  là một hàm từ  $\mathbb{R}^2$  đến  $\mathbb{R}$ . Nếu  $X$  và  $Y$  là rời rạc, thì
...
Ví dụ 7.2.2 (Khoảng cách kỳ vọng giữa hai Uniforms). Gọi X và Y là các biến ngẫu nhiên i.i.d. Unif(0,1). Tìm  $E(|X - Y|)$ .
...
Ví dụ 7.2.3 (Kỳ vọng khoảng cách giữa hai Normal). Với  $X, Y \stackrel{\mathrm{i.i.d.}}{\sim} \mathcal{N}(0, 1)$ , tìm  $E(|X - Y|)$ .
...
Ví dụ 7.2.4 (Tính tuyến tính qua 2D LOTUS). Cho X và Y là các biến ngẫu nhiên liên tục (phương pháp tương tự cũng hoạt động trong trường hợp rời rạc). Theo 2D LOTUS,
