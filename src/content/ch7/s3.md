...
<span class="math-box-number">7.3.1</span>
<span class="math-box-title">(Hiệp phương sai)</span>
</div>
...
<span class="math-box-number">7.3.2</span>
</div>
<div class="math-box-content">
...
$$
\begin{aligned}
E(XY)&=\int_{-\infty}^{\infty}\int_{-\infty}^{\infty}xyf_{X}(x)f_{Y}(y)dxdy\\
&=\int_{-\infty}^{\infty}yf_{Y}(y)\left(\int_{-\infty}^{\infty}xf_{X}(x)dx\right)dy\\
...
&=\operatorname{Cov}(Z,X)+\operatorname{Cov}(W,X)+\operatorname{Cov}(Z,Y)+\operatorname{Cov}(W,Y)\\
...
<span class="math-box-number">7.3.3</span>
</div>
<div class="math-box-content">
...
<div class="math-box-header">
<span class="math-box-name">Định nghĩa</span>
<span class="math-box-number">7.3.4</span>
<span class="math-box-title">(Correlation)</span>
</div>
<div class="math-box-content">
...
<div class="math-box-header">
<span class="math-box-name">Định lý</span>
<span class="math-box-number">7.3.5</span>
<span class="math-box-title">(Các giới hạn của hệ số tương quan)</span>
</div>
<div class="math-box-content">
...
<span class="math-box-number">7.3.6</span>
<span class="math-box-title">(Cực đại và cực tiểu của phân phối mũ)</span>
</div>
<div class="math-box-content">
...
<div class="math-box-header">
<span class="math-box-name">Ghi chú</span>
<span class="math-box-number">7.3.7</span>
</div>
<div class="math-box-content">
...
$$
\begin{aligned}
\operatorname{Var}(X)&=\operatorname{Var}\left(\sum_{j=1}^{n}I_{j}\right)\\
&=\operatorname{Var}(I_{1})+\cdots+\operatorname{Var}(I_{n})+2\sum_{i<j}\operatorname{Cov}(I_{i},I_{j})\\
&=np(1-p)+2\binom{n}{2}\operatorname{Cov}(I_{1},I_{2}),
\end{aligned}
$$
...
$$
\begin{aligned}
\operatorname{Cov}(I_{1},I_{2})&=E(I_{1}I_{2})-E(I_{1})E(I_{2})\\
&=P(\text{bóng thứ 1 và thứ 2 đều trắng})-P(\text{bóng thứ 1 trắng})P(\text{bóng thứ 2 trắng})\\
