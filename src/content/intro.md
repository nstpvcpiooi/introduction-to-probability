...
Các video bài giảng từ khóa học Stat 11,0 tại Harvard, khóa học đã dẫn đến cuốn sách này, được cung cấp miễn phí tại http://stat110.net. Các tài liệu bổ sung như mã R, hoạt ảnh và lời giải các bài tập được đánh dấu với $\textcircled{s}$ cũng có sẵn tại trang web này.
...
Các tài liệu bổ sung mới cũng đã được thêm vào tại http://stat110.net, bao gồm các hoạt ảnh và hình ảnh tương tác được tạo ra trong mối liên hệ với phiên bản online của khóa học Stat 110 trên edX. Những tài liệu này nhằm giúp xác suất cảm giác trở nên trực quan, trực quan và dễ hiểu hơn.
